...
public class Ground {
    ...
    public Ground() {
        ...
        ground[0][0] = new Rook(0, 7, "BR1");
        ground[1][0] = new Knight(1, 7, "BN1");
        ground[2][0] = new Bishop(2, 7, "BB1");
        ground[3][0] = new Queen(3, 7, "BQ ");
        ground[4][0] = new King(4, 7, "BK ");
        ground[5][0] = new Bishop(5, 7, "BB2");
        ground[6][0] = new Knight(6, 7, "BN2");
        ground[7][0] = new Rook(7, 7, "BR2");
        ground[0][1] = new Pawn(0, 6, "BP1");
        ground[1][1] = new Pawn(1, 6, "BP2");
        ground[2][1] = new Pawn(2, 6, "BP3");
        ground[3][1] = new Pawn(3, 6, "BP4");
        ground[4][1] = new Pawn(4, 6, "BP5");
        ground[5][1] = new Pawn(5, 6, "BP6");
        ground[6][1] = new Pawn(6, 6, "BP7");
        ground[7][1] = new Pawn(7, 6, "BP8");
    }
